...
import { getServerAuthSession } from "@/server/authentication/auth";
import { prisma } from "@/server/db";
import { type NextApiRequest } from "next";
import { type CustomErrorFormatter } from "../types";
...
const errorFormatter: CustomErrorFormatter = ({ shape, error }) => {
